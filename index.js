...
const part2Height = part2Div.clientHeight;
...
console.log("Height of 'part2' div:", part4Height, "pixels");

const part1Line = document.getElementById("part1-line");
part1Line.style.height = `${part1Height}px`;
const part2Line = document.getElementById("part2-line");
part2Line.style.height = `${part2Height}px`;
const part3Line = document.getElementById("part3-line");
part3Line.style.height = `${part3Height}px`;
const part4Line = document.getElementById("part4-line");
part4Line.style.height = `${part4Height}px`;
...
// Colors
var colorPalette = {
    bg: {r:13, g:17, b:23}, // Updated to #0d1117
    matter: [
